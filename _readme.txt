A disassembly of the NES demo Quantum Disco Brothers.

* original file: "Quantum Disco Brothers by wAMMA (PD) (PAL).nes"
...
CNROM register: $8000-$ffff = bank select:
    bits: xxDD xxCC
    DD: security diodes config
    CC: CHR-ROM bank select
